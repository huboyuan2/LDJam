...
Description:
	...
	desired (and can interpolate the scale to the new value over time if desired). It
    will also change color during interpolation to make it more noticable
